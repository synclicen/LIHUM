...
import { Image, Shield, LogIn, LogOut } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 select-none">
          <div className="w-10 h-10 bg-[#D4AF37] rounded-lg flex items-center justify-center shadow-lg transform transition-transform hover:scale-105">
            <svg className="w-6 h-6 text-[#4C2A85]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* Constant status indicator inspired by Design HTML */}
          <div className="hidden sm:flex items-center bg-white/10 rounded-full px-3.5 py-1.5 border border-white/20">
            <div className="w-2 h-2 rounded-full bg-green-400 mr-2 animate-pulse"></div>
            <span className="text-white text-[11px] font-medium tracking-wide">Drive Sync Active</span>
          </div>
