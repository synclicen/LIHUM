  ...
  const handleCopy = async () => {
    try {
      ...
      try {
        ...
        alert(
          "Gagal menyalin secara otomatis. Silakan salin tautan berikut secara manual:\n\n" +
            shareUrl
        );
      }
    }
      ...
      >
        ...
        <div className="bg-[#4C2A85] text-white p-6 pb-5 relative">
          ...
          <p className="text-[11px] text-slate-200 mt-1 line-clamp-2 leading-relaxed">
            {project.description ||
              "Silakan bagikan tautan atau kode QR galeri ini."}
          </p>

          {project.displayMode && (
            <div className="mt-3 flex items-center gap-1.5">
              <span
                className={`text-[9px] px-2 py-0.5 rounded-full inline-flex items-center space-x-1 border font-bold ${
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handleCopy}
                className={`px-4 rounded-xl text-xs font-bold font-mono uppercase tracking-wide shrink-0 transition-all flex items-center gap-1.5 ${
                  copied
          ...
          <div className="space-y-4 pt-1 border-t border-slate-200/60 flex flex-col items-center">
            <div className="text-center">
              ...
              <p className="text-[10px] text-slate-400 mt-0.5">
                Pengunjung dapat memotret QR untuk menjelajah langsung di
                smartphone.
              </p>
            </div>
